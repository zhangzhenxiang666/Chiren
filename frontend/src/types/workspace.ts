export interface JdRequirement {
  name: string;
  category: 'hard_skill' | 'soft_skill' | 'tool' | 'domain_knowledge' | 'certification' | 'education' | 'experience' | 'language';
...
export interface Strength {
  description: string;
  type: 'skill_match' | 'experience_match' | 'project_relevance' | 'certification' | 'education_match' | 'unique_advantage';
}
