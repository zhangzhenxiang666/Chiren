      ...
      <div className="flex">
        ...
        <div className="w-[32%] shrink-0 border-r border-zinc-100 bg-zinc-50 p-4">
          {leftSections.map((section) => (
            <div key={section.id} className="mb-5 pt-0.5" data-section>
              <h2 className="mb-2 pb-1.5 border-b border-zinc-200 text-[10px] font-bold uppercase tracking-wider text-zinc-500">{section.title}</h2>
        ...
        <div className="flex-1 p-4">
          {rightSections.map((section) => (
            <div key={section.id} className="mb-5 pt-0.5" data-section>
              <h2 className="mb-2 pb-2 border-b-2 border-zinc-200 text-xs font-bold uppercase tracking-wider text-zinc-700">{section.title}</h2>
              <div className="mt-1.5">
