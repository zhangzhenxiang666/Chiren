    ...
    <div className="mx-auto max-w-[210mm] bg-white shadow-lg" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="px-8 py-8" style={{ background: CHARCOAL }}>
        <div className="flex items-center gap-6">
          {pi.avatar && (
            <AvatarImage src={pi.avatar} size={80} className="shrink-0" style={{ border: `2px solid ${EMERALD}` }} />
          )}
      ...
      {resume.sections
        ...
        .map((section) => (
          <div key={section.id} className="mb-6" data-section>
            <h2 className="mb-3 pb-2 border-b-2 text-sm font-bold uppercase tracking-wider" style={{ color: CHARCOAL, borderColor: EMERALD }}>
              {section.title}
            </h2>
            <div className="mt-2">
