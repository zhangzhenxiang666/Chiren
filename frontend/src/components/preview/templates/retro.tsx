        ...
        .map((section, idx, arr) => (
          <div key={section.id} data-section className="mb-7 pt-2">
            <div className="mb-3 text-center">
              <h2 className="inline-block text-xs font-bold uppercase tracking-[0.3em]" style={{ color: PRIMARY, borderBottom: `2px solid ${PRIMARY}`, borderTop: `2px solid ${PRIMARY}`, padding: '6px 16px' }}>
                {section.title}
              </h2>
            </div>
            <div className="mb-4">
