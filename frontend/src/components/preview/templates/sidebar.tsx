    ...
    <div className="mx-auto flex max-w-[210mm] overflow-hidden bg-white shadow-lg" style={{ fontFamily: 'Inter, sans-serif', minHeight: '297mm' }}>
      ...
      <div className="w-[35%] shrink-0 p-6 text-white" style={{ backgroundColor: SIDEBAR_BG }}>
        ...
        {sidebarSections.map((section) => (
          <div key={section.id} className="mb-6 pt-1" data-section>
            <h2 className="mb-2 pb-1.5 border-b-2 text-xs font-bold uppercase tracking-wider" style={{ color: 'rgba(255,255,255,0.4)' }}>
              {section.title}
            </h2>
            <div className="mt-2">
      ...
      <div className="flex-1 p-6">
        {mainSections.map((section) => (
          <div key={section.id} className="mb-6 pt-1" data-section>
            <h2 className="mb-2 pb-2 border-b-2 text-sm font-bold uppercase tracking-wider" style={{ color: SIDEBAR_BG, borderColor: ACCENT }}>
              {section.title}
            </h2>
            <div className="mt-2">
