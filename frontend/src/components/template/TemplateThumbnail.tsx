...
function AcademicThumb() {
  return (
    <div
      className="flex h-full flex-col px-2.5 py-2"
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <div className="px-2 py-2" style={{ background: "#2d3436" }}>
        <div className="h-1.5 w-10 rounded-full bg-white/90" />
        <div
          className="mt-0.5 h-1 w-7 rounded-full"
      ...
      <div className="flex-1 space-y-1.5 p-2">
        <div>
          <div
            className="mb-0.5 border-b-2 pb-0.5"
    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex-1 space-y-1.5 p-2">
        <div>
          ...
          />
          <div
            className="mt-0.5 border-l-2 pl-1.5 space-y-0.5"
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex-1 space-y-1.5 p-2">
        ...
        <div
          className="border-l-2 pl-1.5 space-y-0.5"
...
function FormalThumb() {
  return (
    <div className="flex h-full flex-col p-2.5" style={{ fontFamily: "serif" }}>
      <div
        className="mb-1.5 border-b-2 pb-1.5 text-center"
    ...
    <div className="flex h-full flex-col p-2.5">
      ...
      <div className="flex-1 space-y-1">
        <div className="flex gap-1.5">
          ...
          <div
            className="flex-1 border-l pl-1.5 space-y-0.5"
...
function TimelineThumb() {
  return (
    <div className="flex h-full flex-col p-2.5">
      ...
      <div
        className="mt-1 flex-1 border-l-2 pl-2 ml-1"
  ...
  return (
    <div className="flex h-full flex-col p-2.5">
      ...
      <div className="space-y-1.5 flex-1">
        <div>
          <div
            className="mb-0.5 rounded-full px-1 py-0.5"
            style={{ background: "#0d9488" }}
          >
  ...
  return (
    <div className="flex h-full flex-col p-2.5" style={{ fontFamily: "serif" }}>
      <div className="mb-1.5">
        ...
        <div
          className="mt-0.5 h-1 w-8 rounded-sm"
...
function RetroThumb() {
  return (
    ...
    >
      <div className="mb-1.5 text-center">
        <div
          className="mx-auto h-1.5 w-10 rounded-sm"
          style={{ background: "#78350f" }}
        />
        <div
          className="mx-auto mt-0.5 h-1 w-7 rounded-sm"
  ...
  return (
    <div className="flex h-full flex-col p-2.5">
      <div className="mb-1.5 text-center">
        ...
        />
        <div
          className="mx-auto mt-0.5 h-1 w-7 rounded-full"
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <div className="relative px-2 py-2 bg-black">
        ...
        />
        <div
          className="absolute right-3.5 top-1 h-1.5 w-1.5"
          style={{ background: "#dc2626" }}
        />
        <div className="h-1.5 w-10 rounded-full bg-white/90" />
        <div
...
function RoseThumb() {
  return (
    <div className="flex h-full flex-col p-2.5">
      <div
        className="mb-1.5 rounded-xl p-1.5"
  ...
  return (
    ...
    >
      <div className="mb-1.5">
        ...
        />
        <div
          className="mt-0.5 h-1 w-7 rounded-sm"
...
function LegalThumb() {
  return (
    <div className="flex h-full flex-col p-2.5" style={{ fontFamily: "serif" }}>
      <div className="mb-1.5 text-center">
        <div
          className="mx-auto h-1.5 w-12 rounded-sm"
  ...
  return (
    ...
    >
      <div className="mb-1.5">
        ...
        />
        <div
          className="mt-0.5 rounded-full px-1 py-0.5"
    ...
    <div className="flex h-full flex-col p-2.5">
      ...
      <div className="space-y-1 flex-1">
        ...
        <div className="rounded p-0.5" style={{ background: "#f5f3ff" }}>
          <div
            className="h-0.5 w-6 ml-auto rounded-full"
            style={{ background: "#8b5cf6" }}
          />
          <div className="mt-0.5 h-0.5 w-full rounded-full bg-violet-100" />
        </div>
